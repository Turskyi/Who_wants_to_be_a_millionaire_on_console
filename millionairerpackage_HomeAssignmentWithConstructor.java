...
public class HomeAssignmentWithConstructor {
    public static void main(String[] args) {
        ...
        String stringQuestion1 = "Which insect shorted out an early supercomputer and inspired the term \"computer bug\"?";
        String answer1 = "A";
        Questions question1 = new Questions(stringQuestion1, answer1, options1);

        String[] options2 = {"A. New Delhi ", "B. Cairo ", "C. Moscow ", "D. Baghdad "};
        String stringQuestion2 = "Now used to refer to a cat, the word \"tabby\" is derived from the name of a district of what world capital?";
        String answer2 = "D";
